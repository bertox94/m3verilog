...
**Please, use the release menu to download our latest version of the project (v1)**
...
More information can be found in the PDF on this repo (https://github.com/bertox94/m3verilog/raw/main/Tiraboschi-Vogrig-ES1-EN.pdf).
